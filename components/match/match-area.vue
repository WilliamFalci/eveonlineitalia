            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                    ...
                    <section>
                        <p>Benvenuti su <strong>EVE Italia</strong>, la <strong>community italiana di EVE
                            ...
                            spaziale. Che tu sia un veterano con anni di esperienza tra stazioni e flotte interstellari,
                            o un nuovo pilota che si avvicina per la prima volta a <strong>EVE Online</strong>, la
                            nostra <strong>community</strong> è il posto ideale per iniziare e crescere insieme.</p>
                    </section>
                    ...
                    <section>
                        ...
                        <ul>
                            ...
                            <li>Condividere guide e approfondimenti sulle meccaniche di <strong>EVE</strong>.</li>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                    <section>
                        ...
                        <ul>
                            <li>Supporto per i nuovi giocatori che vogliono imparare le basi del gioco.</li>
                            <li>Strategie avanzate e consigli da parte dei veterani della <strong>community
                                    italiana</strong>.</li>
                            <li>Discussioni su economia, commercio, PvP, missioni e roleplay.</li>
                            <li>Eventi online, fleet PvP e attività organizzate per vivere appieno <strong>EVE
                                    Online</strong>.</li>
                        </ul>
                    </section>

                    <section>
                        <h2>Unisciti al Discord di EVE Italia</h2>
