<template>
<section class="services__details-area section-pt-120 section-pb-120" style="background-image:url(/images/bg/team_details_bg.jpg)">
  <div class="container">
      <div class="row">
          <div class="col-12">
              ...
              <div class="team__details-content">
                  <span class="sub-title">Best NFT game</span>
