<template>
    <header>
        <div id="sticky-header" :class="`tg-header__area transparent-header tg-header__area-two ${isSticky?'tg-sticky-menu':''} ${isStickyVisible?'sticky-menu__show':''}`">
                            ...
                            <nav class="tgmenu__nav">
                                ...
                                <div class="tgmenu__action d-none d-md-block">
                                    <ul class="list-wrap">
                                        ...
                                        <li @click="handleOpenOffCanvas('/audio/click.wav')" class="side-toggle-icon d-none d-xl-flex">
                                            <span></span>
                                            <span></span>
                                            <span></span>
                                        </li>
