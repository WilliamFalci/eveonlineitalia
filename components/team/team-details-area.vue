<template>
<section class="team__details-area section-pt-120 section-pb-120" 
  style="background-image:url(/images/bg/team_details_bg.jpg)">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="team__details-img">
                    <NuxtImg src="/images/team/team_details.jpg" alt="img"/>
                    <svg-dots/>
                </div>
                <div class="team__details-content">
                    <span class="sub-title">our team member</span>
                    <h2 class="title">Online Games for Everyone Find the Best MMOs FOR YOU.</h2>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="team__details-inner-img">
                                    <NuxtImg src="/images/team/team_details01.jpg" alt="img"/>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="team__details-inner-img">
                                    <NuxtImg src="/images/team/team_details02.jpg" alt="img"/>
                                </div>
                            </div>
                        </div>
                    </div>
